...
libltrace_la_DEPENDENCIES = $(am__DEPENDENCIES_1) \
	...
	$(am__DEPENDENCIES_1) sysdeps/libos.la
am_libltrace_la_OBJECTS = bits.lo breakpoints.lo debug.lo demangle.lo \
	dict.lo ltrace-elf.lo execute_program.lo handle_event.lo \
	libltrace.lo options.lo output.lo proc.lo read_config_file.lo \
	summary.lo library.lo filter.lo glob.lo type.lo value.lo \
	value_dict.lo expr.lo fetch.lo vect.lo param.lo printf.lo \
	zero.lo lens.lo lens_default.lo lens_enum.lo memstream.lo \
	prototype.lo
...
ACLOCAL = ${SHELL} /home/clem/projects/FingerPrint/ltrace/config/autoconf/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AM_CFLAGS =  -Wall -Wsign-compare -Wfloat-equal -Wformat-security -Werror -DDEBUG -DHASH_DEBUG=1
AM_CPPFLAGS =  	-DSYSCONFDIR=\"$(sysconfdir)\" 	 	-I$(top_srcdir)/sysdeps/linux-gnu/x86 	-I$(top_srcdir)/sysdeps/linux-gnu 	-I$(top_srcdir)/sysdeps 	-I$(top_srcdir) 
AM_LDFLAGS = 
AR = ar
AUTOCONF = ${SHELL} /home/clem/projects/FingerPrint/ltrace/config/autoconf/missing --run autoconf
AUTOHEADER = ${SHELL} /home/clem/projects/FingerPrint/ltrace/config/autoconf/missing --run autoheader
AUTOMAKE = ${SHELL} /home/clem/projects/FingerPrint/ltrace/config/autoconf/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/clem/projects/FingerPrint/ltrace/config/autoconf/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_NAME = ltrace
PACKAGE_STRING = ltrace 0.7.90-git
PACKAGE_TARNAME = ltrace
PACKAGE_URL = http://ltrace.alioth.debian.org/
PACKAGE_VERSION = 0.7.90-git
PATH_SEPARATOR = :
RANLIB = ranlib
SED = /bin/sed
SET_MAKE = 
...
STRIP = strip
VERSION = 0.7.90-git
abs_builddir = /home/clem/projects/FingerPrint/ltrace
abs_srcdir = /home/clem/projects/FingerPrint/ltrace
abs_top_builddir = /home/clem/projects/FingerPrint/ltrace
abs_top_srcdir = /home/clem/projects/FingerPrint/ltrace
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/clem/projects/FingerPrint/ltrace/config/autoconf/install-sh
...
libltrace.la: $(libltrace_la_OBJECTS) $(libltrace_la_DEPENDENCIES) $(EXTRA_libltrace_la_DEPENDENCIES) 
...
clean-binPROGRAMS:
	...
	echo " rm -f" $$list; \
	rm -f $$list
ltrace$(EXEEXT): $(ltrace_OBJECTS) $(ltrace_DEPENDENCIES) $(EXTRA_ltrace_DEPENDENCIES) 
	@rm -f ltrace$(EXEEXT)
...
include ./$(DEPDIR)/fetch.Plo
include ./$(DEPDIR)/filter.Plo
include ./$(DEPDIR)/glob.Plo
include ./$(DEPDIR)/handle_event.Plo
include ./$(DEPDIR)/lens.Plo
include ./$(DEPDIR)/lens_default.Plo
include ./$(DEPDIR)/lens_enum.Plo
include ./$(DEPDIR)/libltrace.Plo
include ./$(DEPDIR)/library.Plo
include ./$(DEPDIR)/ltrace-elf.Plo
include ./$(DEPDIR)/main.Po
include ./$(DEPDIR)/memstream.Plo
